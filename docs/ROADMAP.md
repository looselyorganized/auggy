...
- **Public-preview candidate:** `0.5.0-rc.8`, distributed through npm's `next`
  tag. It includes the
  ...
  foundation.
- **Immediate release plan:** validate the published `0.5.0-rc.8` public OSS
...
Status: **public release candidate (`0.5.0-rc.8`)**.
