...
- **[deploy]** Verify `auggy deploy <name> --to railway` works end-to-end on a fresh adopter machine. Doc the limits, the manual steps that remain, the recovery path on failure.
