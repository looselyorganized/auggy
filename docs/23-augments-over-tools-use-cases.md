...
- `agentMail` receives admitted email through AgentMail WebSockets, catches up
  through REST after startup or reconnect, and invokes the model only when its
  durable ledger has work.
