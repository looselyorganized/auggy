...
export const WEB_IDEMPOTENCY_APPLICATION_ID = 0x41554944; // "AUID"
export const WEB_IDEMPOTENCY_SCHEMA_VERSION = 2;
const APPLICATION_ID = WEB_IDEMPOTENCY_APPLICATION_ID;
const SCHEMA_VERSION = WEB_IDEMPOTENCY_SCHEMA_VERSION;
